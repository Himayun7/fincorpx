            ...
            <div className="flex flex-wrap gap-8 lg:justify-between lg:gap-0">
              ...
              >
                ...
                <p className="mb-10 mt-5">
                  ANNA UNIVERSITY, Sir C V Raman Science Block 3rd, Campus,
                ...
                <a className="text-[22px] text-itemtitle text-black dark:text-white">
                  info@fincorpX.com
                </a>
              </motion.div>
              ...
              <div className="flex w-full flex-col gap-8 md:flex-row md:justify-between md:gap-0 lg:w-2/3 xl:w-7/12">
                ...
                >
                  ...
                  <ul>
                    <li>
                      <a
                        href="https://in.linkedin.com/company/fincorpx"
                        className="mb-3 inline-block hover:text-primary"
                      >
                        LinkedIn
                      </a>
                    ...
                    <li>
                      <a
                        href="https://www.instagram.com/fincorpx/"
                        className="mb-3 inline-block hover:text-primary"
                      >
                        Instagram
                      </a>
                    ...
                    <li>
                      <a
                        href="https://x.com/v_nachiyappan?s=11&t=kQwiMWmPxdJ2aG00NGe4mw"
                        className="mb-3 inline-block hover:text-primary"
                      >
                        x
                      </a>
